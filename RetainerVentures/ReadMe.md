...
**RetainerVentures** is a simple plugin that will renew Retainer Ventures for you while running OrderBot. There's not Settings here, whenever it detects a retainer has returned from it's venture, it will find the nearest bell and send them back out again.
